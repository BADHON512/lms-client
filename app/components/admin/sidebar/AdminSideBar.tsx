...
const AdminSideBar = (props: Props) => {
  ...
  return (
    <Sidebar collapsed={Collapse} backgroundColor="#070930">
      <div className="w-full h-screen overflow-y-auto p-5 ">
        ...
        <div className={`${!Collapse && "pl-8"} mt-5`}>
          ...
          <h1 className={`${Collapse&& 'hidden'} font-Poppins font-[400] my-3`}>Data</h1>
 ...
 <h1 className={`${Collapse&& 'hidden'} font-Poppins font-[400] my-3`}>Content</h1>
...
<h1 className={`${Collapse&& 'hidden'} font-Poppins font-[400] my-3`}>Customization</h1>
...
<h1 className={`${Collapse&& 'hidden'} font-Poppins font-[400] my-3`}>Analysis</h1>
...
<h1 className={`${Collapse&& 'hidden'} font-Poppins font-[400] my-3`}>Extras</h1>
