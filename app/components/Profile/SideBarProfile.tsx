  ...
  return (
    <div className='w-full'>
      <div className={`w-full flex items-center px-3 py-4 cursor-pointer ${active===1 ?'dark:bg-slate-800 bg-[#ddd3d3]':' bg-transparent'}`} onClick={()=>setActive(1)}>
        <Image height={20} width={20} src={user.avatar|| avatar?user.avatar.url||avatar:avatarDefault} alt='img not fund' className='w-[20px] h-[20px] 800px:w-[30px] 800px:h-[30px] cursor-pointer rounded-full'/>
